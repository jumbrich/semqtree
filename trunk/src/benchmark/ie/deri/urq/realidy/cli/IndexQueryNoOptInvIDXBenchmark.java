...
public class IndexQueryNoOptInvIDXBenchmark extends CLIObject{
	private final static Logger log = LoggerFactory.getLogger(IndexQueryNoOptInvIDXBenchmark.class);
	...
	protected void execute(CommandLine cmd) {
		...
		try {
			...
			if(qre!=null){
				serialiseQueryResultEstimation(qre, new File(outDir,idx.getLabel()+".no_opt_inv."+query.getName()+".ser"));
