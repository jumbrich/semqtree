...
import ie.deri.urq.wods.query.JoinOpVisitor;
...
public class JoinBasedQueryTEST extends TestCase {
	...
	_index = AbstractIndex.loadIndex(new File("tmp/hmario_b50_f10_min1_max1000"));
...
//        ARQ.getContext().set(ARQ.stageGenerator, msg) ;
	...
	JoinOpVisitor v = new JoinOpVisitor(_index, 200, null);
        QTreeDataset ds =  new QTreeDataset(1,v, null);
