 ...
 *
 */
public class AverageBucketLength extends QPenaltyFunction {

	/**
	 * @param id
	 */
	public AverageBucketLength() {
		super("AverageBucketLength");
	}
	...
	public double calculatePenalty(int[] dimSpecMin, int[] dimSpecMax, Bucket b) {
		...
		return (area / (double) b.getLowerBoundaries().length);	
	}
