...
public class IndexQueryInvIDXBenchmark extends CLIObject{
	private final static Logger log = LoggerFactory.getLogger(IndexQueryInvIDXBenchmark.class);
	...
	protected void execute(CommandLine cmd) {
		...
		((SemQTree)idx).setInvBucketOperator(true);
		...
		try {
			...
			QueryThread t = new QueryThread(idx,sparql,true);
			...
			if(qre!=null){
				serialiseQueryResultEstimation(qre, new File(outDir,idx.getLabel()+".inv_idx."+query.getName()+".ser"));
