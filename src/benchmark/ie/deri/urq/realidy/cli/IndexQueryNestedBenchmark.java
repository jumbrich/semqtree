...
public class IndexQueryNestedBenchmark extends CLIObject{
	private final static Logger log = LoggerFactory.getLogger(IndexQueryNestedBenchmark.class);
	...
	protected void execute(CommandLine cmd) {
		...
		try {
			...
			if(qre!=null){
				serialiseQueryResultEstimation(qre, new File(outDir,idx.getLabel()+".nested."+query.getName()+".ser"));
